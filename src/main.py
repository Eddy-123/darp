...
def run(args):
	...
	if args.verbose:
		print("-- Running Model with {} cities --")
		
	history = ga.run_ga(genes, args.pop_size, args.n_gen, args.tourn_size, args.mut_rate, args.verbose)
	...
	if __name__ == "__main__":
		...
		parser.add_argument('--cities_fn', type=str, default="data/cities.csv", help='Data containing the graphical coordinates of cities')
		random.seed(datetime.now())
		args = parser.parse_args()
		
		if args.tourn_size > args.pop_size:
			raise argparse.ArgumentTypeError('Tournament siez cannot be bigger than population size.')
