...
def selection(population, tabu_length):
    '''
         Select parent individuals
    '''
    individu = get_best_current(population)
    tabu_list = tabu_search(individu, tabu_length)
    return tabu_list
...
population_size = 500 #Population
